        ...
        <form id="form1" runat="server">
            <div>
                ...
                <div class="table-container">
                    <h6 class="sub-logo-header text-center">Comment List</h6>
                    ...
                    <asp:GridView ID="EmpGridView" ShowHeaderWhenEmpty="True" AutoGenerateColumns="false" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CssClass="auto-style8" OnSelectedIndexChanged="EmpGridView_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Comment" HeaderText="Comment" ItemStyle-Width="1000">
                                <ItemStyle Width="200px"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="UserID" HeaderText="UserID" ItemStyle-Width="200">
                                <ItemStyle Width="200px"></ItemStyle>
                            </asp:BoundField>
                            <asp:TemplateField>
                                <ItemTemplate>
